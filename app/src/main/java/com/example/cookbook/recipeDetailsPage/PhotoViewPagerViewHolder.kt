...
class PhotoViewPagerViewHolder<T>(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun photoSettings(photo: T) {
        if (photo is Photo) {
            ...
            initGlide("https://firebasestorage.googleapis.com/v0/b/cookbook-92037.appspot.com/o/vpAwThITFWNpGke8JIPSJ1kNe9C2%2FTartine%20d'avocat%2Fphoto_4.jpg?alt=media&token=f19095a8-e6a1-4e5b-9fc0-e0ffdfdb7b47")
        }
    }
